...
@Component
({
    selector: 'newmarksurvey-component',
    templateUrl: 'newmarksurvey.html'
})

export class NewMarketSurveyComponent
{
    surveyMarketForm: FormGroup;
    date = '';
    mode ='date';
    ...
    constructor(private fb: FormBuilder)
    {
     ...
     createSurveyForm() 
     {
        this.surveyMarketForm = this.fb.group({
    ...
    setQuestions(questions: Questions[]) 
    {
        ...
        this.surveyMarketForm.setControl('questions', questsFormArray);
     }
  
    get questions(): FormArray {
        return this.surveyMarketForm.get('questions') as FormArray;
      };
